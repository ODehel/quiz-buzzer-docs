...
| Mécanisme ping/pong | Frames natifs RFC 6455 — `ws.ping()` / événement `pong` |
| Intervalle | 30 secondes |
| Pings manqués tolérés | 3 avant fermeture |
| Code de fermeture | `1000` (Normal Closure) |
| Périmètre d'application | Connexions authentifiées uniquement |
| Architecture | Module indépendant injectant le registre des connexions (US-009) |
| Testabilité | Fonction `setInterval` injectable en paramètre |
