...
| Bibliothèque de logging | `pino` (dernière version stable disponible) |
| Rotation des fichiers | `pino-roll` (dernière version stable disponible) |
| Pretty-print développement | `pino-pretty` (dernière version stable disponible) |
